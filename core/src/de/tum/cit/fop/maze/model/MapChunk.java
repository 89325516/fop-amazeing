 ...
 * 
 * Represents a 64x64 block in Endless Mode map.
 * Used for sliced loading and rendering optimization.
 */
public class MapChunk {

    /** Chunk X coordinate (chunk units, not grid units) */
    private final int chunkX;

    /** Chunk Y coordinate (chunk units) */
    private final int chunkY;

    /** Chunk size (number of tiles) */
    private final int size;

    /** Chunk theme */
    private String theme;

    /** Wall entities within the chunk */
    private List<WallEntity> walls;

    /** Trap positions within the chunk */
    private List<Vector2> trapPositions;

    /** Treasure chest positions within the chunk */
    private List<Vector2> chestPositions;

    /** Enemy spawn points within the chunk */
    private List<Vector2> spawnPoints;

    /** Whether already generated */
    private boolean isGenerated;

    /** Whether already loaded into the rendering system */
    private boolean isLoaded;

    /** Last access time (for LRU caching) */
    ...
    /**
     * Gets the starting X of the chunk in world coordinates (grid units).
     */
    ...
    /**
     * Gets the starting Y of the chunk in world coordinates (grid units).
     */
    ...
    /**
     * Gets the ending X of the chunk in world coordinates (grid units, exclusive).
     */
    ...
    /**
     * Gets the ending Y of the chunk in world coordinates (grid units, exclusive).
     */
    ...
    /**
     * Checks if the specified world coordinates are within this chunk.
     */
    ...
    /**
     * Adds a treasure chest position.
     */
    ...
    /**
     * Clears chunk content (releases memory).
     */
    public void clear() {
        walls.clear();
        trapPositions.clear();
