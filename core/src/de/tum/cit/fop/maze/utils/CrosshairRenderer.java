 ...
 * Crosshair Renderer.
 * 
 * Draws a crosshair at the mouse position to indicate the attack direction.
 * Supports multiple crosshair styles and dynamic effects.
 */
public class CrosshairRenderer {
    ...
    private static final float CROSSHAIR_SIZE = 6f; // Line length (world units)
    private static final float CROSSHAIR_GAP = 2f; // Center gap size
    private static final float CROSSHAIR_THICKNESS = 1.5f; // Line thickness
    private static final Color CROSSHAIR_COLOR = new Color(1f, 1f, 1f, 0.8f); // White semi-transparent
    ...
    public void render(Camera camera, float worldX, float worldY) {
        ...
        // Attack feedback: shrink crosshair
        float scale = 1f;
    ...
    /**
     * Triggers the attack feedback animation.
     */
