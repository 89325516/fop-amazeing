 ...
 * 
 * Generates random rewards based on game mode (Level/Endless).
 * Follows SRP: only responsible for reward generation logic.
 */
public class ChestRewardGenerator {
    ...
    private static Weapon generateRandomWeapon(Random random) {
        ...
        float x = 0, y = 0; // Position will be updated on pickup
    ...
    /**
     * Generate reward based on game mode.
     * 
     * @param isEndlessMode Whether it's Endless Mode
     * @param random        Random number generator
     * @return Random reward
     */
