 ...
 * Provides a complete manual for gameplay, controls, and systems.
 */
public class HelpScreen implements Screen {
    ...
    public HelpScreen(MazeRunnerGame game) {
        ...
        // Use exactly the same viewport setup as other Screens
    ...
    public void render(float delta) {
        ...
        if (backgroundTexture != null) {
            ...
            // Set projection matrix to screen pixel coordinates
            batch.getProjectionMatrix().setToOrtho2D(0, 0, screenWidth, screenHeight);
            batch.begin();
            batch.setColor(0.4f, 0.4f, 0.4f, 1f); // Dim

            // Original background texture size
        ...
        // Restore Stage's Viewport (resets correct glViewport)
