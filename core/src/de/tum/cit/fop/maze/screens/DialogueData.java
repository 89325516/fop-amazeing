...
public class DialogueData {
        ...
        // Speaker type enum
        public enum Speaker {
                SYSTEM("System", new Color(0.2f, 1f, 0.4f, 1f)), // Tech green
                DOCTOR("Doctor", new Color(0.7f, 0.85f, 1f, 1f)), // Warm light blue
                ALIEN_SYSTEM("Alien System", new Color(1f, 0.42f, 0.42f, 1f)); // Red warning
        ...
        // Array of all level dialogues (indexed by level number for easy access)
        ...
        /**
         * Gets dialogue data based on level number.
         * 
         * @param levelNumber Level number (1-20)
         * @return Corresponding dialogue data, or null if level number is invalid
         */
        ...
        /**
         * Extracts level number from map path.
         * 
         * @param mapPath Map file path, e.g., "maps/level-5.properties"
         * @return Level number, or -1 if parsing fails
         */
