...
/**
 * Centralized management of all adjustable game parameters.
 * 
 * Function Description:
 * - Hardcoded default values (DEFAULT_*): System original default values, not
 * modifiable
 * - User default values: Custom default values defined and saved by player in
 * menu
 * - Current values: Values used in current game (adjustable in game)
 * 
 * Usage:
 * - Call loadUserDefaults() at game startup to load user custom default values
 * - Call saveAsUserDefaults() after adjusting parameters in menu to save
 * - Call resetToUserDefaults() at start of new level to reset to user defaults
 * - Current values can be temporarily adjusted in game without affecting saved
 * defaults
 */
public class GameSettings {
    ...
    // ==================== Hardcoded Default Values (not modifiable)
    // ====================
    ...
    // ==================== User Custom Defaults (loaded/saved from file)
    // ====================
    ...
    // ==================== Current Values (used for current game session)
    // ====================
    ...
    public static float gridSnapSpeed = 10.0f; // Snap speed
    ...
    public static int KEY_INVENTORY; // Inventory hotkey

    // ==================== Save/Load User Defaults ====================

    /**
     * Load user custom default values from file.
    ...
    /**
     * Save current values as user custom defaults.
     * Should be called when clicking "Save" in menu settings.
     */
    ...
    /**
     * Save only key bindings settings (these are always persistent).
     * Used for in-game settings UI, does not save speed and other session settings.
     */
    ...
    /**
     * Resets current values to user custom default values.
     * Should be called at the start of each new level.
     */
    ...
    /**
     * Reset user defaults to hardcoded defaults and save.
     */
