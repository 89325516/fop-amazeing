...
public class SkillScreen implements Screen {
    ...
    private final boolean isVictory; // Tracks if the player entered via victory or defeat
    private final boolean isInGameAccess; // Whether accessed from in-game pause menu
    private Stage stage;
    private GameState gameState;

    /**
     * Constructor - Requires knowing if player entered Skill Tree via victory or
     * defeat.
     *
     * @param game         Game instance
     * @param currentLevel Current level path
     * @param isVictory    true=Entered after victory, false=Entered after defeat
     */
    ...
    /**
     * In-game access constructor - Used when accessing from pause menu.
     *
     * @param game           Game instance
     * @param currentLevel   Current level path
     * @param isVictory      Whether victory mode (ignored when accessing in-game)
     * @param isInGameAccess true=Entered from pause menu, returns to game on exit
     */
    ...
    public void show() {
        ...
        // 4. Done Button - Returns to correct screen based on entry mode
        ...
        doneBtn.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                // Return correct screen based on entry state
                if (isInGameAccess) {
                    // Entered from pause menu, return to game and apply new skills
                    // Use loadPersistentStats=true to ensure skill values are loaded
                    ...
                    // Return to LevelSummaryScreen (Defeat mode) after defeat
    ...
    private void addSkillRow(Table table, Skin skin, String name, String statInfo, int cost, Runnable onBuy) {
        ...
        table.add(buyBtn).width(260).height(60).padBottom(40); // Increase width to ensure text fits
        table.row();
    }
