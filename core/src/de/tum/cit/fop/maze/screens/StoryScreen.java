 ...
 * Supports dynamic dialogue data, displaying different dialogues and
 * backgrounds based on the level.
 */
public class StoryScreen implements Screen {
    ...
    /**
     * Constructor - Used for intro dialogue (when starting a New Game).
     */
    ...
    /**
     * Constructor - Used with specified dialogue data.
     */
    public StoryScreen(MazeRunnerGame game, String nextMapPath, DialogueData.LevelDialogue dialogueData) {
        ...
        // Debug log - confirm StoryScreen created
        ...
        // Use FitViewport to ensure UI consistency across screen sizes
        this.stage = new Stage(new FitViewport(1920, 1080), game.getSpriteBatch());

        // Load background image
        loadBackgroundTexture();

        // Create dialog box visual elements
    ...
    /**
     * Static factory method - Creates a dialogue screen based on the level number.
     */
    public static StoryScreen forLevel(MazeRunnerGame game, String mapPath) {
        ...
        if (dialogue != null) {
            ...
            // If no corresponding dialogue is found, enter the game directly
            return null;
        }
    }
    ...
    /**
     * Creates visual textures for the dialog box (gradient background + borders).
     */
    private void createDialogBoxTextures() {
        // Create gradient dialog box background
        int boxHeight = 50;
    ...
    /**
     * Sets UI element layout - elegant visual novel style.
     */
    private void setupUI() {
        ...
        // --- Bottom row: page indicator + buttons ---
        ...
        // Add dialog box to main container
    ...
    /**
     * Logic for when Continue is clicked.
     */
    private void onContinueClicked() {
        currentLineIndex++;
        if (currentLineIndex >= dialogueData.lines.length) {
            // Dialogue complete, enter ArmorSelectScreen
