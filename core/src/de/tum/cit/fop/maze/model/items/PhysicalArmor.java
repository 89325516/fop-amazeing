 ...
 * Physical Armor.
 * 
 * - Absorbs physical damage (PHYSICAL).
 * - Completely ineffective against magical damage (MAGICAL).
 * - Suitable when facing enemies with physical attacks like swords or
 * crossbows.
 */
