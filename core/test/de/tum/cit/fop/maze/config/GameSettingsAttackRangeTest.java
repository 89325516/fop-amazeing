...
public class GameSettingsAttackRangeTest {
    ...
    /**
     * Tests that the attack range setting is enabled by default.
     */
    @Test
    ...
    /**
     * Tests toggling the attack range setting on and off.
     */
    @Test
    ...
    /**
     * Tests the persistence of the attack range setting.
     * Verifies that the setting is correctly saved to and loaded from user
     * preferences.
     */
    @Test
